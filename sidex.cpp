...
//##########################################################################################
#define SIDEXVERSION "Rev 2.8 final?"//
#define LIBSIDPLAYVERSION "2.3.1 2021-12-07"//
...
//
extern double _StereoEnhanca[4];
extern double brickwall(double insamp, int type);
extern float voices[], softlmax, sofldefault,SDELAY, fadevolume, _decode_buffer[];
extern int 		eqpresetoffset,preset[], BANDEQ, surroundcount, LPFILTER, HPFILTER, PREAMP, SURROUNDSEPERATION, SURROUNDSEPFORCE, SURROUNDEMP, surround, VOICE_1SID[], VOICE_2SID[], VOICE_3SID[], _8580VOLUMEBOOST, _buffer_fill, real2sid, real3sid; //wgc
...
char aboutinfo[] = {
	...
	"Copyright (c) 2021 William Cronin & Nathan Hindley\n\n"
