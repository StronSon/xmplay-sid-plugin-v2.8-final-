...
int timedsurround = 0;
int PREAMP = 75;
int VOICE_1SID[3] = { 0,0,0 };
int VOICE_2SID[ 3] = { 0,0,0 };
int VOICE_3SID[ 3] = { 0,0,0 };
float  fadevolume = 0;
...
double dbmax = 0;
double db_level = -10; // more minus = lower volume
double db_headroom = 1;
double db_attack = 0.1; // rate of volume increases
double db_decay = 0.025/2; // rate volume decreases
